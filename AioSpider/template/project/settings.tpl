...
# 日志配置
LOGGING = {
    'LOG_NAME': '${project.upper}',                       # 日志名称
    'LOG_PATH': "log/${project.upper}.log",               # 日志存储路径
    'LOG_CMD_FORMAT': '%(asctime)s - %(levelname)s: %(message)s',   # 控制台输出日志格式
...
# 数据管道
ITEM_PIPELINES = {
    "${project}.pipelines.${project.upper}Pipeline": 200,
}
...
DOWNLOAD_MIDDLEWARE = {
    ...
    "${project}.middleware.${project.upper}Middleware": 200,
}
